...
<body>
	...
	<div class="main-container" id="main-container">
		...
		<div class="main-container-inner">
			...
			<s:set name="subMenuName">category</s:set>
							...
							<div class="dataTables_wrapper">
								<div class="row">
									<div class="col-sm-6">
										...
										<button type="button" class="btn btn-primary btn-xs batch" value="batchDelete" disabled onclick="batch(this)"> 批量删除 </button>
									</div>
									<div class="col-sm-6">
									...
									<table class="table table-striped table-bordered table-hover dataTable" contenteditable="false" style="">
										...
										<tbody>
											<s:iterator value="pageBean.list" var="categoryList">
												<tr class="active">
													...
													<td><i class="<s:if test="#categoryList.isTop == 1">icon-ok</s:if><s:else>icon-remove</s:else> bigger-110"></i>
													</td>
