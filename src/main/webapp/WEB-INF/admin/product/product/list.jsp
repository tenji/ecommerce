							...
							<div class="dataTables_wrapper">
								<div class="row">
									<div class="col-sm-6">
										...
										<a href="${path }/admin/product/product/create.htm"><button type="button" class="btn btn-primary btn-xs">新建</button></a>
									...
									<table class="table table-striped table-bordered table-hover dataTable" contenteditable="false" style="">
										...
										<tbody>
											<s:iterator value="pageBean.list" var="productList">
												<tr class="active">
													...
													<a href='${path }/admin/product/product/edit.htm?id=<s:property value='id'/>'>
