...
<html>
  <head>
    <title>Ram Account Operation Log - ${projectName }</title>
...
<body>
	...
	<div class="main-container" id="main-container">
		...
		<div class="main-container-inner">
			...
			<c:set var="subMenuName" value="logAdminRamAccount"></c:set>
			...
			<div class="main-content">
				...
				<div class="breadcrumbs" id="breadcrumbs">
					...
					<ul class="breadcrumb">
						...
						<li class="active">Ram Account Operation Log</li>
					</ul><!-- .breadcrumb -->
					...
					<div class="row">
						...
						<div class="col-xs-12">
									...
									<div class="widget-main">
										<form class="form-inline" action="${path }/admin/log/adminLogin/list.htm">
											<div class="form-group">
												...
												<input type="text" class="" name="email" placeholder="email" value="${model.email }">
											</div>
							...
							<div class="table-header">
								Results for "Ram Account Operation Log"
							</div>
								...
								<tbody>
									<c:forEach items="${pageBean.list }" var="model" varStatus="st">
										<tr class="active">
											...
											<td>${st.count }</td>
											<td>${model.ramAccount.email }</td>
											<td>${model.points }</td>
											<td>
											<fmt:formatDate value="${model.beginTime }" pattern="yy-MM-dd HH:mm:ss" />
											</td>
											<td>
											<fmt:formatDate value="${model.endTime }" pattern="yy-MM-dd HH:mm:ss" />
											</td>
											<td>
