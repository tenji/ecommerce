	...
	<div class="navbar-container" id="navbar-container">
		<div class="navbar-header pull-left">
			<a href="#" class="navbar-brand"> <small> <i
					class="icon-leaf"></i> ECommerce Admin </small> </a>
			<!-- /.brand -->
		</div>
		<!-- /.navbar-header -->
			...
			<ul class="nav ace-nav">
				<li class="grey"><a data-toggle="dropdown"
					class="dropdown-toggle" href="#"> <i class="icon-tasks"></i> <span
						class="badge badge-grey">4</span> </a>
				...
				<li class="green"><a data-toggle="dropdown"
					...
					<ul
						...
						<li><a href="#"> <img
								src="${path }/assets/admin/avatars/avatar.png"
								class="msg-photo" alt="Alex's Avatar" /> <span class="msg-body">
									...
									class="msg-time"> <i class="icon-time"></i> <span>a
											moment ago</span> </span> </span> </a></li>

						<li><a href="#"> <img
								src="${path }/assets/admin/avatars/avatar3.png"
								class="msg-photo" alt="Susan's Avatar" /> <span
								class="msg-body"> <span class="msg-title"> <span
										class="blue">Susan:</span> Vestibulum id ligula porta felis
										euismod ... </span> <span class="msg-time"> <i
										class="icon-time"></i> <span>20 minutes ago</span> </span> </span> </a></li>

						<li><a href="#"> <img
								src="${path }/assets/admin/avatars/avatar4.png"
				...
				<li class="light-blue"><a data-toggle="dropdown" href="#"
					class="dropdown-toggle"> <img class="nav-user-photo"
						src="${path }/assets/admin/avatars/user.jpg" alt="Jason's Photo" />
						<span class="user-info"> <small>Welcome,</small> ${systemSessionBean.userName} </span> <i
					...
					<ul
						...
						<li><a href="${path }/admin/account/profile/view"> <i class="icon-user"></i> Profile </a></li>

						<li class="divider"></li>

						<li><a href="${path }/admin/logout"> <i class="icon-off"></i> Logout </a></li>
					</ul></li>
			</ul>
			<!-- /.ace-nav -->
		</div>
