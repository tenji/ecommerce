...
<body>
	...
	<div class="main-container" id="main-container">
		...
		<div class="main-container-inner">
			...
			<s:set name="subMenuName">propertyName</s:set>
							...
							<div class="dataTables_wrapper">
								<div class="row">
									...
									<table class="table table-striped table-bordered table-hover dataTable" contenteditable="false" style="">
										...
										<tbody>
											<s:iterator value="pageBean.list" var="propertyName">
												<tr class="active">
													...
													<td><i class="<s:if test="#propertyName.allowAlias==1">icon-ok</s:if><s:else>icon-remove</s:else> bigger-110"></i></td>
													<td><i class="<s:if test="#propertyName.isColor==1">icon-ok</s:if><s:else>icon-remove</s:else> bigger-110"></i></td>
													<td><i class="<s:if test="#propertyName.isEnumerated==1">icon-ok</s:if><s:else>icon-remove</s:else> bigger-110"></i></td>
													<td><i class="<s:if test="#propertyName.isInput==1">icon-ok</s:if><s:else>icon-remove</s:else> bigger-110"></i></td>
													<td><i class="<s:if test="#propertyName.isKey==1">icon-ok</s:if><s:else>icon-remove</s:else> bigger-110"></i></td>
													<td><i class="<s:if test="#propertyName.isSale==1">icon-ok</s:if><s:else>icon-remove</s:else> bigger-110"></i></td>
													<td><i class="<s:if test="#propertyName.isSearch==1">icon-ok</s:if><s:else>icon-remove</s:else> bigger-110"></i></td>
													<td><s:date name="createTime"
															format="yy-MM-dd HH:mm:ss" /></td>
													<td>
													<button type="button" class="btn btn-primary btn-xs btn-read" value='<s:property value="id"/>'>查看</button>
													<button type="button" class="btn btn-primary btn-xs btn-edit" value='<s:property value="id"/>'>编辑</button>
