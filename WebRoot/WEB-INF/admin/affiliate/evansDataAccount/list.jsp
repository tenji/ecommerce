...
<html>
  <head>
    <title>Evans Data Accounts Lists - ${projectName }</title>
...
<script type="text/javascript">
	...
	function answerInit(buttonObj) {
		EC.showLoadingLayer(); // 添加加载层
		// 发送AJAX请求
		var url = "${path}" + "/admin/affiliate/evansDataAccount/answer";
	  	$.ajax({
	  		...
	  		success: function(list) {
	  			...
	  			if (handleAjaxResults(list)) {
					EC.createNoty("success", "更新成功");
	  				...
	  				setTimeout(function() { location.reload(true); }, 5000); // Reload after 5 seconds
				}
	  		},
	  		error: function() {
...
<body>
	...
	<div class="main-container" id="main-container">
		...
		<div class="main-container-inner">
			...
			<c:set var="subMenuName" value="evansDataAccount"></c:set>
			...
			<div class="main-content">
				...
				<div class="breadcrumbs" id="breadcrumbs">
					...
					<ul class="breadcrumb">
						...
						<li class="active">Evans Data Accounts</li>
					</ul><!-- .breadcrumb -->
				...
				<div class="page-content">
					<div class="row">
						...
						<div class="col-xs-12">
							<!-- Explanation Well -->
							<div class="well">
								<h4 class="green smaller lighter">Something about Evans Data DevNet.</h4>
								Evans Data analysts conduct extensive secondary research each year to determine the software developer population for the top 30 in the world.
							</div>
							...
							<div class="table-header">
								Results for "Evans Data Accounts"
							</div>
							...
							<div class="dataTables_wrapper">
								...
								<thead>
									<tr>
										...
										<th style="">EMail</th>
										<th>Password</th>
										<th style="">Available Points</th>
										<th style="">Pending Points</th>
								...
								<tbody>
									<c:forEach items="${pageBean.list }" var="model" varStatus="st">
										<tr class="active">
											...
											<td>${model.availablePoints }</td>
											<td>${model.pendingPoints }</td>
