...
$(document).ready(function() {
	...
	$(".btn-delete").on('click', function() {
		var url = "${path}" + "/admin/system/sysUser/delete.htm";
		// 发送AJAX请求
		$.ajax({url : url, data: {"id" : crud.operatedObj.val()}, dataType : 'json', async: false, type : 'POST',
			...
			error : function() {
				createNoty("error", "操作失败，请重试！"); // 操作失败提示
			}
		});
	});
